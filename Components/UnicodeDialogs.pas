...
type
 ...
 public
    ...
    property Files: TStringListW read FFiles;
  published
...
begin
  ...
  begin
    ...
    TempFilter := AllocFilterStr(FFilter) + #0;
...
procedure TOpenDialogW.GetFileNames;
  ...
  begin
    ...
    begin
      ...
      Chain := PWideChar(Ptr(Integer(Chain) + lstrlenw(Chain) * 2 + 2))
    end;
